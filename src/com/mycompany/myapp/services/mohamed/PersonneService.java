 ...
 */
package com.mycompany.myapp.services.mohamed;
...
public class PersonneService {
 ...
 public void ajouterPersonne(Personne p){
     ...
     con.setPost(false);
        String Url = "http://localhost:81/TGTOf/web/app_dev.php/user/insert"+"?username="+p.getUsername()+"&email="+p.getEmail()+"&enabled="+p.getEnabled()+"&password="+p.getPassword()+"&confirmationtoken="+p.getConfirmation_token()+"&roles="+p.getRoles();
        con.setUrl(Url);
     ...
     ConnectionRequest con = new ConnectionRequest();
     con.setPost(false);
        String Url = "http://localhost:81/TGTOf/web/app_dev.php/user/mod"+"?id="+p.getId()+"&username="+p.getUsername()+"&email="+p.getEmail()+"&enabled="+p.getEnabled()+"&password="+p.getPassword()+"&confirmationtoken="+p.getConfirmation_token()+"&roles="+p.getRoles();
        con.setUrl(Url);
  ...
  public void getUser(String username,String email) {
       ...
       ConnectionRequest connectionRequest = new ConnectionRequest() {
        ...
        connectionRequest.setUrl("http://localhost:81/TGTOf/web/app_dev.php/user/get");
